<section class="relative h-[700px] w-full bg-cover bg-center" style="background-image: url('{{ asset('image/hero.png') }}')">
    ...
    <div class="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex h-full flex-col justify-center items-center text-center text-white">
            ...
            <a href="#" class="relative mt-6 inline-block px-12 py-3 bg-red-700 text-white text-lg font-semibold rounded-lg shadow-lg transition-colors duration-300 hover:bg-red-800">
